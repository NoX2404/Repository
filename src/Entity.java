public class Entity {
    ...
    public String sprite(){
       ...
       static Entity Zombie = new Entity(1000, 100, 500, "a Zombie", 40);//Infected player everything same except more def for virus
       static Entity Golem = new Entity(1000, 50, 1000, "a Golem", 50);//Bulky enemy made of rocky material hence high def
       static Entity Giant = new Entity(6000, 100, 200, "a Giant", 60);//Large and beefy enemy hence has high hp
